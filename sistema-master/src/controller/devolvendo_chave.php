...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    try {
        ...
        $sqlRegistro = "INSERT INTO registro (data_emp, data_dev, id_chave, id_func) VALUES (:null, :data_dev, :id_chave, :id_func)";
        ...
        if ($stmtRegistro->execute()) {
            header("Location: ../../views/devolver_chave.php?sucesso=1");
        } else {
            header("Location: ../../views/devolver_chave.php?erro=0");
        }
